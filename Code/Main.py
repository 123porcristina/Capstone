...
def main():
    ...
    X, y, X_train, X_test, y_train, y_test, categorical_features_indices = accidents.split_data(df, target=target)
    ...
    X_train_res, y_train_res = model.oversampling_cat(X_train, y_train)
